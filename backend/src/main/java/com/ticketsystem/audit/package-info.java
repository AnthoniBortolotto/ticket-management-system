/**
 * Historico append-only de transicoes de status e reatribuicoes.
 *
 * <p>Modulo ainda sem implementacao. Ao criar a primeira classe aqui, anote este pacote
 * com {@code @ApplicationModule(displayName = "Auditoria")}: a partir dai o Modulith passa a
 ...
 */
package com.ticketsystem.audit;
